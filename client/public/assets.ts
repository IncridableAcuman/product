...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Girls Round Neck Cotton Top',
    description:
      'Harp lightweight, usually knitted, pullover shirt, close-fitting and with a round neckline and short sleeves, worn as an undershirt or outer garment.',
    price: 200,
    image: [p_img27],
    category: 'Kids',
    subCategory: 'Topwear',
